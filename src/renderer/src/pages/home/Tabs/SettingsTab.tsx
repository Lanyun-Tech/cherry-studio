...
import { Button, Col, InputNumber, Row, Select, Slider, Switch, Tabs, Tooltip } from 'antd'
...
const SettingsTab: FC<Props> = (props) => {
  ...
  const renderAssistantSettings = () => (
    <SettingGroup>
      <SettingRow>
        <SettingRowTitleSmall>{assistant.name}</SettingRowTitleSmall>
        <Button
          type="text"
          size="small"
    ...
    <Container className="settings-tab">
      <Tabs
        ...
        items={[
          {
            key: 'assistant',
            label: t('assistants.settings.title'),
            children: (
              <>
          ...
          },
          {
            ...
            children: renderMessagesSettings()
          },
          {
            key: 'code',
            label: t('chat.settings.code.title'),
            children: renderCodeSettings()
          },
          {
            key: 'input',
            label: t('settings.messages.input.title'),
            children: renderInputSettings()
          }
        ]}
      />
    </Container>
